          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <NavLink
                ...
                className="block hover:text-blue-700 text-gray-600 font-inter py-2 px-3 rounded md:bg-transparent md:border-0 md:hover:text-black-700 md:p-0 dark:text-white md:dark:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                Predict
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                className="block py-2 px-3 text-gray-600 font-inter md:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                About
              </NavLink>
            </li>
            <li>
              {userLoggedIn ? (
                <>
                  <button
                    className="btn-sm flex text-gray-600 font-inter md:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                    onClick={() => {
                      doSignOut().then(() => {
                        navigate("/login");
                      });
